...
def get_documents(run_id: int = None, corpus_id: int = None, page_size: int = None, skip: int = 0, search: str = "") -> List[Document]:
    if search:
        return get_orbis_service().search_documents(search, page_size, skip)
    if run_id:
