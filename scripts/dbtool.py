...
if __name__ == '__main__':
    ...
    parser.add_argument('--create-database', help='Create or recreated the Obris database.')
    parser.add_argument('-f', '--force', help='Force potentially destructive actions without user confirmation.')
