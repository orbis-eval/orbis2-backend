...
def test_content_extraction_f1_multiple_documents():
    reference = {
        '0': [Annotation("", "Ehre sei Gott in der Höhe!", 30, 56,
                         annotation_type=AnnotationType("praise"), annotator=ANNOTATOR),
              Annotation("", "Und Friede den Menschen, die guten Willens sind.", 90, 138,
                         annotation_type=AnnotationType("praise"), annotator=ANNOTATOR)
              ]
    }
    ...
    annotator = {
        '0': [Annotation("", "Ehre sei Gott", 30, 43,
                         annotation_type=AnnotationType("praise"), annotator=ANNOTATOR),
              Annotation("", "Friede den Menschen, die guten Willens sind. Im Himmel", 94, 148,
                         annotation_type=AnnotationType("praise"), annotator=ANNOTATOR)
              ]
    }
    ...
    assert res.mR == 10 / 14, "Inncorrect mR"
